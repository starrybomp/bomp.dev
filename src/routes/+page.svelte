...
<div class="bg-zinc-900 flex flex-col w-1/3 mt-6 p-4 pl-8 pr-12 pt-4 pb-10 pt-8 ml-6 rounded-lg shadow justify-center">
  ...
  <div class="mt-2 flex flex-row gap-2 containter grid grid-cols-3">
